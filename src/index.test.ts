...
const testData = [
  { id: 1, name: 'Alice', age: 25, city: 'New York', active: true, tags: ['dev', 'js'] },
  { id: 2, name: 'Bob', age: 30, city: 'London', active: false, tags: ['dev', 'python'] },
  { id: 3, name: 'Charlie', age: 35, city: 'New York', active: true, tags: ['dev', 'java'] },
  { id: 4, name: 'David', age: 28, city: 'Paris', active: true, tags: ['design'] },
];
...
describe('queryJSON', () => {
  describe('Basic Operators', () => {
    ...
    test('in operator', () => {
      const result = queryJSON(testData, { city: { $in: ['New York', 'Paris'] } });
  ...
  describe('Edge Cases', () => {
    ...
    test('invalid input data', () => {
      expect(() => queryJSON(null as any, {})).toThrow('Input data must be an array');
    });

    test('invalid query', () => {
      expect(() => queryJSON(testData, null as any)).toThrow('Query must be an object');
    });
  });
}); 